# https://github.com/gretelai/public_research/blob/513fe3241cafe640620a47fe23e0eb2042610232/fbd_fcsd_research/text_metrics/metrics.py
import math
...
def calc_FBD(real_mean: Any,
    ...
    try:
        res = (diff.dot(diff) + np.trace(real_var) + np.trace(synth_var) - 2 * np.trace(covmean))
